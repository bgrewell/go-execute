...
type Executor interface {
	...
	ExecuteAsync(command string) (*ExecutionResult, err error)
	ExecuteAsyncWithInput(command string, stdin io.ReadCloser) (*ExecutionResult, err error)
	...
	ExecuteAsyncWithTimeout(command string, timeout time.Duration) (*ExecutionResult, err error)
